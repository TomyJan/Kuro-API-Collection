...
> https://api.kurobbs.com/activity/task/complete
...
| 字段    | 类型      | 内容     | 备注                                               |
| ------- | --------- | -------- | -------------------------------------------------- |
| code    | num       | 返回值   | 1806: 完成失败<br />220: cookie过期<br />200: 成功 |
| message | str       | 提示信息 | success, 貌似和 msg 一样                           |
| msg     | str       | 提示信息 | success, 1806 = 您的网络不稳定，请稍后重试         |
...
```js
const url = 'https://api.kurobbs.com/activity/task/complete'
const headers = {
    pragma: 'no-cache',
